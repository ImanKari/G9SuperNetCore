    ...
    internal sealed class ECDsaX509SignatureGenerator : X509SignatureGenerator
    {
        ...
        public override byte[] SignData(byte[] data, HashAlgorithmName hashAlgorithm)
        {
            ...
            return DerEncoder.ConstructSequence(
                DerEncoder.SegmentedEncodeUnsignedInteger(ieeeFormat.Take(segmentLength).ToArray()),
                DerEncoder.SegmentedEncodeUnsignedInteger(ieeeFormat.Skip(segmentLength).Take(segmentLength).ToArray()));
        }
        ...
        protected override PublicKey BuildPublicKey()
        {
            ...
            {
                throw new InvalidOperationException("Cryptography_ECC_NamedCurvesOnly");
            }
