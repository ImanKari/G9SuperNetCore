...
namespace System.Security.Cryptography.X509Certificates
{
    ...
    public sealed class CertificateRequest
    {
        ...
        {
            if (_generator == null)
                throw new InvalidOperationException("Cryptography_CertReq_NoKeyProvided");
        ...
        public X509Certificate2 CreateSelfSigned(DateTimeOffset notBefore, DateTimeOffset notAfter)
        {
            if (notAfter < notBefore)
                throw new ArgumentException("Cryptography_CertReq_DatesReversed");
            if (_key == null)
                throw new InvalidOperationException("Cryptography_CertReq_NoKeyProvided");
            ...
            byte[] serialNumber)
        {
            ...
            if (!issuerCertificate.HasPrivateKey)
                throw new ArgumentException("Cryptography_CertReq_IssuerRequiresPrivateKey", nameof(issuerCertificate));
            if (notAfter < notBefore)
                throw new ArgumentException("Cryptography_CertReq_DatesReversed");
            ...
            if (issuerCertificate.PublicKey.Oid.Value != PublicKey.Oid.Value)
            {
                throw new ArgumentException(
                    "Cryptography_CertReq_AlgorithmMustMatch" + 
            ...
            {
                throw new ArgumentException(
                    "Cryptography_CertReq_NotBeforeNotNested: " +
                        notBeforeLocal+
            ...
            {
                throw new ArgumentException(
                    "Cryptography_CertReq_NotAfterNotNested: " +
                        notAfterLocal +
            ...
            if (basicConstraints == null)
                throw new ArgumentException("Cryptography_CertReq_BasicConstraintsRequired", nameof(issuerCertificate));
            if (!basicConstraints.CertificateAuthority)
                throw new ArgumentException("Cryptography_CertReq_IssuerBasicConstraintsInvalid", nameof(issuerCertificate));
            if (keyUsage != null && (keyUsage.KeyUsages & X509KeyUsageFlags.KeyCertSign) == 0)
                throw new ArgumentException("Cryptography_CertReq_IssuerKeyUsageInvalid", nameof(issuerCertificate));
            ...
            try
            {
                switch (keyAlgorithm)
                {
                    case Oids.RsaRsa:
                        if (_rsaPadding == null)
                        {
                            throw new InvalidOperationException("Cryptography_CertReq_RSAPaddingRequired");
                        }
                    ...
                    default:
                        throw new ArgumentException(
                            "Cryptography_UnknownKeyAlgorithm: "+ keyAlgorithm,
                            nameof(issuerCertificate));
                }
